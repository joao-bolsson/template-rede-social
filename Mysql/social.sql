...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-10-2014 a las 18:15:17
...
CREATE TABLE IF NOT EXISTS `admin_settings` (
  ...
  `new_registrations` enum('0','1') NOT NULL DEFAULT '1' COMMENT '0 Off, 1 On',
  `email_verification` enum('0','1') NOT NULL DEFAULT '1' COMMENT '0 Off, 1 On',
  `ad` text NOT NULL,
  `bg_navbar` varchar(40) NOT NULL,
  `color_link_navbar` varchar(40) NOT NULL,
  `color_icons_verified` varchar(40) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
INSERT INTO `admin_settings` (`id`, `title`, `description`, `keywords`, `message_length`, `post_length`, `new_registrations`, `email_verification`, `ad`, `bg_navbar`, `color_link_navbar`, `color_icons_verified`) VALUES
(1, 'Social ™ Microblogging PRO', 'Social Microblogging PRO - Discover, Share and  Communicate with Yours', 'social,media,micro-blogging', 140, 140, '1', '1', '<a href="http://miguelvasquez.net"><img src="public/img_ad/ad.jpg"></a>', '#ffffff', '#9c9c9c', '#5890ff');
...
CREATE TABLE IF NOT EXISTS `interactions` (
  ...
  `type` enum('1','2','3','4','5','6') NOT NULL COMMENT '1 Follow, 2 Reposted, 3 favorite, 4 reply, 5 Mentions, 6 Mentions in replies',
  `status` enum('0','1') NOT NULL COMMENT '0 No, 1 Yes',
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `trash` enum('0','1') NOT NULL DEFAULT '0' COMMENT '''0 No'',''1Yes''',
  PRIMARY KEY (`id`),
  KEY `destination` (`destination`,`autor`,`target`,`status`),
  KEY `trash` (`trash`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Volcado de datos para la tabla `pages_general`
--
...
(2, 'Terms of Service', '<p style="text-align: left;">\r\nLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of<b> <a href="http://www.hola.com">Lorem</a></b><a href="http://www.hola.com"> </a>Ipsum</p><div style="text-align: center;"></div>', 'terms'),
...
(7, 'Jobs', '<strong>Jobs coming soon</strong>', 'jobs');
...
CREATE TABLE IF NOT EXISTS `posts` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `repost_of_id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL COMMENT 'User ID original post',
  ...
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `status_general` enum('0','1') NOT NULL DEFAULT '1' COMMENT '0 Delete, 1 Active',
  `url_soundcloud` varchar(255) NOT NULL,
  `title_soundcloud` varchar(255) NOT NULL,
  `thumbnail_song` varchar(255) NOT NULL,
  `doc_site` varchar(100) NOT NULL,
  ...
  KEY `status_general` (`status_general`),
  KEY `url_soundcloud` (`url_soundcloud`),
  KEY `title_soundcloud` (`title_soundcloud`),
...
CREATE TABLE IF NOT EXISTS `profile_design` (
  ...
  `cover_position` varchar(50) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `messages_private` enum('0','1','2') NOT NULL DEFAULT '1' COMMENT '0 Everyone, 1 following, 2 Nobody',
  `email_notification_follow` enum('0','1') NOT NULL DEFAULT '1' COMMENT '''0 No'',''1Yes''',
  `email_notification_msg` enum('0','1') NOT NULL DEFAULT '1' COMMENT '''0 No'',''1Yes''',
