...
if( 
  ...
  if( isset( $_POST ) && $_SERVER['REQUEST_METHOD'] == "POST" ) {
	...
	$response          = $obj->getFollowers(
	'WHERE F.following = '. $id_user .' && F.id '.$query.' '.$offset .'', 'LIMIT '.$postnumbers, $id_user_favs );
		    	  	...
		    	  	<div class="media li-group">
		                    <div class="pull-left">
		                       <a href="<?php echo URL_BASE.$key['username']; ?>" class="openModal" data-id="<?php echo $key['id']; ?>">
		                       	<img src="<?php echo URL_BASE."thumb/100-100-public/avatar/".$key['avatar']; ?>" alt="Avatar" class="media-object img-rounded">
		                       </a>
		                    </div>
