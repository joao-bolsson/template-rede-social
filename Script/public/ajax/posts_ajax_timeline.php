	...
	<div class="panel-heading timeline-title">
			  	<div class="pull-left col-avatar">
			  		<a class="openModal" href="'.URL_BASE.$getPosts[$i]['username'].'" data-id="'.$_idUser.'">
			  			<img src="'.URL_BASE.'thumb/45-45-public/avatar/'.$getPosts[$i]['avatar'].'" alt="Avatar" class="media-object img-rounded" width="45"></a>
			  	</div>
			  ...
			  <div class="panel-footer content-ajax details-post">
				...
				<span href="#" class="pull-left">
	                <img alt="" src="'.URL_BASE.'thumb/40-40-public/avatar/'.$infoUser->avatar.'" class="media-object img-rounded" width="40">
	            </span>
