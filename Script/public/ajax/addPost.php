...
if ( 
  ...
  if ( isset ( $_SESSION['authenticated'] ) ) {
		...
		if( $isValidYoutube ==  1 && $_POST['photoId'] == '' ) {
			...
			$_POST['video_thumbnail'] = 'http://img.youtube.com/vi/'.$idVideoYoutube.'/0.jpg';
					  ...
					  <div class="panel-heading timeline-title">
					  	...
					  	<div class="pull-left col-avatar">
					  		<a class="openModal" href="<?php echo URL_BASE.$infoUser->username; ?>" data-id="<?php echo $_SESSION['authenticated']; ?>">
					  			<img src="<?php echo URL_BASE.'thumb/45-45-public/avatar/'.$infoUser->avatar; ?>" alt="Avatar" class="media-object img-rounded" width="45"></a>
					  	</div>
	...
	<div class="container-media grid-media"></div>
			...
			<div class="media">
	            ...
	            <span href="#" class="pull-left">
	                <img alt="" src="<?php echo URL_BASE.'thumb/40-40-public/avatar/'.$infoUser->avatar; ?>" class="media-object img-circle" width="40">
	            </span>
