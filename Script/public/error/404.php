  ...
  <body>
    ...
    <div class="row col-pb">
      ...
      <div class="col-md-12 text-center">
      	<h6 class="icon-error"><i class="fa fa-chain-broken"></i></h6>
      	<h1 class="title-error"><span>Error</span> 404</h1>
      	<p class="subtitle-error">Sorry, that page does not found!	</p>
      	<a class="btn btn-danger btn-border" href="./"><i class="fa fa-home myicon-right"></i> Go to home page</a>
     </div><!--/col-md-* -->
