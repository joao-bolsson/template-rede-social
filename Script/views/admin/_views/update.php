        ...
        <div class="col-lg-6">
         ...
         <form action="" method="post" enctype="multipart/form-data" id="upload">
         	...
         	<div class="form-group">
		     	...
		     	<input readonly="readonly" class="form-control" style="opacity: 1; cursor: default; border: 1px solid #000; color:#FFF; background: <?php echo $this->settings->bg_navbar; ?>" type="text" class="color form-control input-sm" id="bg_color" value="" />
		     ...
		     <div class="form-group">
		     	...
		     	<input readonly="readonly" class="form-control" style="opacity: 1; cursor: default; border: 1px solid #000; color:#FFF; background: <?php echo $this->settings->color_link_navbar; ?>" type="text" class="color form-control input-sm" id="icons_color" value="" />
		     ...
		     <div class="form-group">
		     	...
		     	<input readonly="readonly" class="form-control" style="opacity: 1; cursor: default; border: 1px solid #000; color:#FFF; background: <?php echo $this->settings->color_icons_verified; ?>" type="text" class="color form-control input-sm" id="verified_color" value="" />
          ...
          <ul class="list-inline">
          	...
          	<li>
          		<a href="admin/?info_user=<?php echo $a['id'] ?>" title="<?php echo stripslashes( $a['name'] )." @".$a['username'] ?>">
          			<img class="img-thumbnail img-responsive" src="<?php echo URL_BASE ?>thumb/62-62-public/avatar/<?php echo $a['avatar'] ?>" />
          		</a>
          	</li>
          	  <?php }//  ?>
          </ul>
